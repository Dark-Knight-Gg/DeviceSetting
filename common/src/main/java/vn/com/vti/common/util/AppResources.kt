...
import vn.com.vti.common.model.UiColor
import java.util.*
...
fun Context.getThemeColor(
    @AttrRes colorAttrResId: Int,
    fallbackColor: UiColor = UiColor.Plain(Color.TRANSPARENT)
): Int {
    return MaterialColors.getColor(this, colorAttrResId, fallbackColor.getBy(this))
}
